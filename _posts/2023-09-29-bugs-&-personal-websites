...
When I came in, there was a station set up where someone had been sketching some sort of large beetle (stag beetle? I'm not sure) with a scope and a light, which makes me want to see if public surplus has any cheap microscopes again - I'd like to draw eith one! I do think that remembering the characteristics of each family under the microscope and drawing it later is an interesting challenge (and what I did last time, and will probably do today).
